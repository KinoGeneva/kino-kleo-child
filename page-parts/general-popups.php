      ...
      <?php do_action('kleo_before_login_form');?>
        ...
        <div class="kleo-pop-title-wrap main-color">
            ...
            <?php if(get_option('users_can_register')) : ?>
                ...
                <p>
                    <em>or</em>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php if (function_exists('bp_is_active')) bp_signup_page(); else echo get_bloginfo('url')."/wp-login.php?action=register"; ?>" class="new-account"><?php _e( "Create an account", "kleo_framework" ); ?></a>
                </p>

            <?php endif; ?>
        </div>

        <form action="<?php echo wp_login_url(home_url( '/inscription-kino/ ' )); ?>" id="login_form" name="login_form" method="post" class="kleo-form-signin">
  ...
  <div class="row">
    <div class="col-sm-12 text-center">
      ...
      <form id="forgot_form" name="forgot_form" action="" method="post" class="kleo-form-signin">
        ...
        <a href="#kleo-login-modal" class="kleo-show-login kleo-other-action pull-right"><?php _e( 'I remember my details' );?></a>
        <span class="clearfix"></span>
      </form>
